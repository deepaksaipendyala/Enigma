...
class CosSimTests(unittest.TestCase):
    ...
    def test_cosine_similarity(self):
        ...
        self.assertEqual(
            round(expected_cosine_similarity, 2), round(actual_cosine_similarity, 2)
        )
    ...
    def test_not_found_song(self):
        ...
        self.assertEqual(actual_song_attributes, expected_song_attributes)
    ...
    def test_both_found_alternate(self):
        ...
        self.assertEqual(
            round(actual_cosine_similarity, 4), round(expected_cosine_similarity, 4)
        )
